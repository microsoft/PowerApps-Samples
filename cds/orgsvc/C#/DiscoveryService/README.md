...
This sample uses the SDK Assembly `Microsoft.Xrm.Tooling.Connector` to query the global discovery service with a user's credentials to determine which environments they can connect with.
