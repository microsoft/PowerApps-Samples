   ...
   public partial class SampleProgram
    {
        ...
        public static List<StatusOption> GetValidStatusOptions(CrmServiceClient service,String entityLogicalName, int currentStatusValue)
        {
            ...
            var entityProperties = new MetadataPropertiesExpression(new string[] { "Attributes", "EnforceStateTransitions" });
            ...
            var attributeProperties = new MetadataPropertiesExpression(new string[] { "OptionSet" });
        ...
        public static String GetOptionSetLabel(EnumAttributeMetadata attribute, int value)
        {
            String label = "";
