        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                if (service.IsReady)
                {
                    ...
                    var entityProperties = new MetadataPropertiesExpression(new string[] { "Attributes" });
                    ...
                    var statusAttribute = (StatusAttributeMetadata)response.EntityMetadata[0].Attributes[0];
