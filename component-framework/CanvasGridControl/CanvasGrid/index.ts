...
// Register icons - but ignore warnings if they have been already registered by PowerApps
...
export class CanvasGrid implements ComponentFramework.StandardControl<IInputs, IOutputs> {
    ...
    loadNextPage = (): void => {
        this.currentPage++;
        this.context.parameters.records.paging.loadNextPage();
    };

    loadPreviousPage = (): void => {
        this.currentPage--;
        this.context.parameters.records.paging.loadPreviousPage();
    };
    ...
    public updateView(context: ComponentFramework.Context<IInputs>): void {
        ...
        const resetPaging =
            datasetChanged && !dataset.loading && !dataset.paging.hasPreviousPage && this.currentPage !== 0;
