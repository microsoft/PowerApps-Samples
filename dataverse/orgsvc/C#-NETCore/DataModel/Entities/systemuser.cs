...
namespace MyApp.DataModel
{
	...
	public partial class SystemUser : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<MyApp.DataModel.Appointment> lk_appointment_createdby
		{
			get
			{
				return this.GetRelatedEntities<MyApp.DataModel.Appointment>("lk_appointment_createdby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_appointment_createdby");
				this.SetRelatedEntities<MyApp.DataModel.Appointment>("lk_appointment_createdby", null, value);
		...
		public System.Collections.Generic.IEnumerable<MyApp.DataModel.Appointment> lk_appointment_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntities<MyApp.DataModel.Appointment>("lk_appointment_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_appointment_createdonbehalfby");
				this.SetRelatedEntities<MyApp.DataModel.Appointment>("lk_appointment_createdonbehalfby", null, value);
		...
		public System.Collections.Generic.IEnumerable<MyApp.DataModel.Appointment> lk_appointment_modifiedby
		{
			get
			{
				return this.GetRelatedEntities<MyApp.DataModel.Appointment>("lk_appointment_modifiedby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_appointment_modifiedby");
				this.SetRelatedEntities<MyApp.DataModel.Appointment>("lk_appointment_modifiedby", null, value);
		...
		public System.Collections.Generic.IEnumerable<MyApp.DataModel.Appointment> lk_appointment_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntities<MyApp.DataModel.Appointment>("lk_appointment_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_appointment_modifiedonbehalfby");
				this.SetRelatedEntities<MyApp.DataModel.Appointment>("lk_appointment_modifiedonbehalfby", null, value);
		...
		public System.Collections.Generic.IEnumerable<MyApp.DataModel.Appointment> user_appointment
		{
			get
			{
				return this.GetRelatedEntities<MyApp.DataModel.Appointment>("user_appointment", null);
			}
			set
			{
				this.OnPropertyChanging("user_appointment");
				this.SetRelatedEntities<MyApp.DataModel.Appointment>("user_appointment", null, value);
