...
namespace PowerPlatform.Dataverse.CodeSamples
{
    internal class Program
    {
        ...
        private static Guid CreateRecord(IOrganizationService organizationService, string deviceId, ref string sessionToken)
        {
            ...
            CreateResponse response = (CreateResponse)organizationService.Execute(request);
        ...
        private static void UpdateRecord(IOrganizationService organizationService, Guid contosoSensorDataId, string deviceId, ref string sessionToken)
        {
            ...
            UpdateResponse response = (UpdateResponse)organizationService.Execute(request);
        ...
        private static void UpdateRecordWithAlternateKey(IOrganizationService organizationService, Guid contosoSensorDataId, string deviceId, ref string sessionToken)
        {
        ...
        private static void RetrieveRecord(IOrganizationService organizationService, Guid contosoSensorDataId, string deviceId, string sessionToken)
        {
        ...
        private static void RetrieveRecordWithAlternateKey(IOrganizationService organizationService, Guid contosoSensorDataId, string deviceId, string sessionToken)
        {
        ...
        private static bool UpsertRecord(IOrganizationService organizationService, Guid contosoSensorDataId, string deviceId, string sessionToken)
        {
        ...
        private static void DeleteRecord(IOrganizationService organizationService, Guid contosoSensorDataId, string deviceId, string sessionToken)
        {
        ...
        private static void DeleteRecordWithAlternateKey(IOrganizationService organizationService, Guid contosoSensorDataId, string deviceId, string sessionToken)
        {
        ...
        private static List<Guid> CreateMultipleRecords(IOrganizationService organizationService, string deviceId)
        {
            ...
            {
                createdRecordIds.AddRange(CreateMultiple(organizationService, entitiesToProcess));
        ...
        private static Guid[] CreateMultiple(IOrganizationService organizationService, List<Entity> entities)
        {
            ...
            CreateMultipleResponse createMultipleResponse = (CreateMultipleResponse)organizationService.Execute(createMultipleRequest);

            Console.WriteLine($"Created {entities.Count()} {"contoso_sensordata"} records.\n");
            return createMultipleResponse.Ids;
        }

        private static List<EnergyConsumption> ExecuteCosmosSqlQuery(IOrganizationService organizationService, string deviceId)
        {
        ...
        private static void UpdateMultipleRecords(IOrganizationService organizationService, string deviceId, List<Guid> createdRecordIds)
        {
            ...
            while ((entitiesToProcess = entityList.Skip(skipRecordCount).Take(Settings.BatchSize).ToList()) != null
                && entitiesToProcess.Count > 0)
            {
                UpdateMultiple(organizationService, entitiesToProcess);
                skipRecordCount += entitiesToProcess.Count;
                entitiesToProcess.Clear();
            }
        }

        private static void UpdateMultiple(IOrganizationService organizationService, List<Entity> entities)
        {
            ...
            organizationService.Execute(updateMultipleRequest);

            Console.WriteLine($"Updated {entities.Count} {"contoso_sensordata"} records.\n");
        }

        private static void DeleteMultipleRecords(IOrganizationService organizationService, string deviceId, List<Guid> recordIds)
        {
            ...
            {
                DeleteMultiple(organizationService, referencesToProcess);
                skipRecordCount += referencesToProcess.Count;
                referencesToProcess.Clear();
            }
        }

        private static void DeleteMultiple(IOrganizationService organizationService, List<EntityReference> entityReferences)
        {
            ...
            organizationService.Execute(deleteMultipleRequest);
