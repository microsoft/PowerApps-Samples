...
namespace PowerPlatform_Dataverse_CodeSamples
{
    internal class Program
    {
            ...
            EntityReference> entityStore)
        {
            ...
            entityStore.Add("Example Account", new EntityReference("account", setupAccount.Id));
            ...
            entityStore.Add("Team First Coffee", new EntityReference("team", setupTeam.Id));
        ...
        static public bool Run(IOrganizationService service,
            Dictionary<string, EntityReference> entityStore)
        {
            AssignRecord(service, entityStore["Example Account"], entityStore["Team First Coffee"]);
            Console.WriteLine("The account is now owned by the team.");
