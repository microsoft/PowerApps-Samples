...
public class EntityParameters
{
    ...
    public override string ToString()
    {
        ...
        str.AppendLine($"EntityName: {this.EntityName}");
        str.AppendLine($"FilterCriteria: [{this.FilterCriteria}]");
        str.AppendLine($"ForbiddenSecuredFields: [{this.ForbiddenSecuredFields.ToString()}]");
        str.AppendLine($"OwnerIds: [{this.OwnerIds.ToString()}]");
        str.AppendLine($"OwningBusinessUnits: [{this.OwningBusinessUnits.ToString()}]");
        str.AppendLine($"SharedToPrincipalIds: [{this.SharedToPrincipalIds.ToString()}]");
        str.AppendLine($"PrimaryIdAttribute: [{this.PrimaryIdAttribute}]");
        return str.ToString();
    }
}