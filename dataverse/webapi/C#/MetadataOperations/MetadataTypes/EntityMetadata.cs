...
namespace PowerApps.Samples.Metadata
{
    ...
    {       
        ...
        /// </summary>
        [JsonProperty]
        public List<SecurityPrivilegeMetadata> Privileges { get; private set; } = new List<SecurityPrivilegeMetadata>();
        /// <summary>
        ...
        public List<EntitySetting> Settings { get; set; } = new List<EntitySetting>();
        ...
        [JsonProperty]
        public List<AttributeMetadata> Attributes { get; private set; } = new List<AttributeMetadata>();
        [JsonProperty]
        public List<EntityKeyMetadata> Keys { get; private set; } = new List<EntityKeyMetadata>();
        [JsonProperty]
        public List<ManyToManyRelationshipMetadata> ManyToManyRelationships { get; private set; } = new List<ManyToManyRelationshipMetadata>();
        [JsonProperty]
        public List<OneToManyRelationshipMetadata> ManyToOneRelationships { get; private set; } = new List<OneToManyRelationshipMetadata>();
        [JsonProperty]
        public List<OneToManyRelationshipMetadata> OneToManyRelationships { get; private set; } = new List<OneToManyRelationshipMetadata>();
    }
}