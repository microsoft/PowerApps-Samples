...
After importing the solution, empty the cache and do a hard refresh of the environment within the browser. This should ensure changes are reflected within the forms.