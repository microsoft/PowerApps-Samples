...
{
	Write-Host "No service principal was found in the current tenant with appId: $HttpWithAADAppAppId. Trying to create one."
	...
	If (!$HttpWithAADAppServicePrincipal)
	{
		Write-Warning "Unable to create a service principal for appId: $HttpWithAADAppAppId."
		Exit
	}
}
